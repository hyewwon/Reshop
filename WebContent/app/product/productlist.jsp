      ...
      <section id="main" class="wrapper style1">
		...
		<table style="border: 10%; width: 100%">
			<tr align="center" valign="middle">
				<td>
					<c:if test="${page>1}">
						<a href="${pageContext.request.contextPath}/admin/ProductList.pd?page=${page-1}">[&lt;]</a>
					</c:if> 
					<c:forEach begin="${startPage}" end="${endPage}" step="1" var="i">
						<c:choose>
							...
							<c:otherwise>
								<a
									href="${pageContext.request.contextPath}/admin/ProductList.pd?page=${i}">[${i}]</a>
							</c:otherwise>
						</c:choose>
					</c:forEach> 
