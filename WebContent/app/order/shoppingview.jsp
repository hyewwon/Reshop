...
<c:import url="../../header.jsp" charEncoding="UTF-8"></c:import>
	...
	<div id="wrapper">
		<section id="main" class="wrapper style1">
			<div class="inner">
			<section>
				<h3 style="text-align:center;">일반 상품 목록</h3><hr>
				<c:choose>
						<c:when test="${prodList !=null and fn : length(prodList)>0}">
							...
							<c:forEach items="${prodList}" var="product">
									<c:if test="${product.classify eq '일반 상품'}">
								<div class="col-4"><span class="image fit">
										<a href="${pageContext.request.contextPath}/user/NormprodSelected.us?prodnum=${product.prodnum}">
				...
				<div style="margin: 2%">
					...
					<table style="border: 10%; width: 100%">
						<tr align="center" valign="middle">
							<td><c:if test="${page>1}">
									<a
										href="${pageContext.request.contextPath}/admin/ProductListForUser.pd?page=${page-1}">[&lt;]</a>
									...
									<c:choose>
										...
										<c:otherwise>
											<a
												href="${pageContext.request.contextPath}/admin/ProductListForUser.pd?page=${i}">[${i}]</a>
										</c:otherwise>
									</c:choose>
