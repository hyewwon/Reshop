	...
	<div id="wrapper">
		...
		<section id="main" class="wrapper style1">
			...
			<form method="post" name="myForm">
				<h4>사이즈를 선택해 주세요</h4>
				<c:choose>
					<c:when test="${product.prodsize eq 'S'}">
						<div class="col-4 col-12-small">
							<input type="radio" id="demo-priority-low" name="demo-priority"
								checked> <label for="demo-priority-low">S</label>
						</div>
					</c:when>
					<c:when test="${product.prodsize eq 'M'}">
						<div class="col-4 col-12-small">
							<input type="radio" id="demo-priority-normal" name="demo-priority" checked>
							<label for="demo-priority-normal">M</label>
						</div>
					</c:when>
					<c:when test="${product.prodsize eq 'L'}">
						<div class="col-4 col-12-small">
							<input type="radio" id="demo-priority-high" name="demo-priority" checked>
