...
<c:import url="../../header.jsp" charEncoding="UTF-8"/>
	...
	<div>
		...
		<form method="post" name="boardForm" action="${pageContext.request.contextPath}/board/NoticeWriteOk.bo" enctype="multipart/form-data">	
			<!-- 게시글 작성하는 인풋들 배치 테이블 -->
			<table border="1" style="border-collapse:collapse;">
				...
				<tr height="300px">
					...
					<td>
						<textarea name="notice_contents" style="width:700px;height:250px;resize:none;"></textarea>					
					</td>
			...
			<table style="border:0px;">
				<tr align="right" valign="middle">
					<td>
						...
						<a class="button primary small" href="${pageContext.request.contextPath}/board/NoticeList.bo">목록</a> <!--?page=${page} -->
					</td>
				</tr>
			</table>
		</form>
