...
<c:import url="../../header.jsp" charEncoding="UTF-8"></c:import>
	...
	<div>
		...
		<form method="post" name="newsForm" action="${pageContext.request.contextPath}/board/NewsModifyOk.bo?news_num=${news.news_num}" enctype="multipart/form-data">
			<!-- 게시글 작성하는 인풋들 배치 테이블 -->
			<table border="1" style="border-collapse:collapse;">
				<tr height="30px">
					...
					<td>
						<input name="news_title" size="50" maxlength="100" value="${news.news_title}">
					</td>
				</tr>
				<tr height="300px">
					<th width="150px" style="text-align: center; font-weight: bold;">
					...
					<td>
						<textarea name="news_contents" style="width:700px;height:250px;resize:none;">${news.news_contents}</textarea>					
					</td>
				</tr>
				<c:choose>
