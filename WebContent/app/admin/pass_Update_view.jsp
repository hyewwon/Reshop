         ...
         <section id="main" class="wrapper style1">
            <div class="inner">
               <section>
                  ...
                  <form method="post" name="userForm" action="${pageContext.request.contextPath}/user/PassModifyOk.us?userid=${user.userid}">
                     <div class="row gtr-uniform">
                        <div class="col-6 col-12-xsmall">
                        아이디
                           <input type="text" value="${user.userid}" name="id" readonly/>
                        </div>
                        <div class="col-6 col-12-xsmall">
                        비밀번호
                           <input type="password" value="${user.userpw}" readonly/>
                        </div>
                        <div class="col-6 col-12-xsmall">
                        이름
                        ...
                        <div class="col-12" >
                        구매금액
                           <input type="text" value="${user.buy}" name="buy" readonly />
                           ...
                           <div class="col-12">
                              <ul class="actions fit" align="middle">
                                 ...
                                 <li><a href="javascript:sendit()" class="button">수정 완료</a></li>
                                 <li><a href="javascript:admin('${user.userid}');" class="button primary" >삭제하기</a></li>
                                 <li><a href="${pageContext.request.contextPath}/user/ManageUser.us" class="button">고객 현황으로 돌아가기</a></li>
                              </ul>
                           </div>
                     </div>
                  </form>
                  <form action="${pageContext.request.contextPath}/user/DeleteUser.us" name="deleteForm">
...
function sendit() {
   ...
   if (zipeTag.value == "" || zipeTag.value == null) {
      alert("우편번호를 입력하세요.");
      addrTag.focus();
      return false;
   }
   ...
   if (buyTag.value == "" || buyTag.value == null) {
      alert("구매금액을 입력하세요.");
      addrTag.focus();
      return false;
   }
