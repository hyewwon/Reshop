<!-- 성훈 : 매출 관리 페이지에서 날짜 검색 했을 때 나오는 view -->
...
<%--    <c:if test="${login_id == null}">
   ...
   <c:set var="orderList" value="${requestScope.datelist}" />
         ...
         <div class="table-wrapper">
            <table class="alt" style="text-align: center;">
               <thead>
                  ...
                  <td><input type="text" 
                      maxlength="2" minlength="2" name="startday"></td>

                  <td><input type="text" 
                      maxlength="4" name="finishyear"></td>
                  ...
                  <td>
                     <input type="text" maxlength="2" minlength="2"  name="finishday">
                  </td>
