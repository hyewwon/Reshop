...
//			int notice_num = ndao.getSeq(userid);
			...
			if(fcheck1 && fcheck2) {
				...
				forward.setPath(request.getContextPath()+"/board/NewsList.bo?flag=false");
				wdao.deleteNews(news_num);
			}
		}else {
