...
public class DeliverListAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int pageSize = 10;
		//전체 게시글 개수
		int totalCnt = ddao.getDeliverCnt();
		...
		request.setAttribute("DeliverList", ddao.getDeliverList(startRow,endRow));
		ActionForward forward = new ActionForward(false,"/app/admin/deliverlist.jsp");
		return forward;
	}
}
