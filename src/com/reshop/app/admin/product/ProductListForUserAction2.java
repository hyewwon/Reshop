...
public class ProductListForUserAction2 implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int pageSize = 9;
		//전체 게시글 개수
		int totalCnt = pdao.getProdCntForUser2();
		...
		request.setAttribute("prodList", pdao.getProdListForUser2(startRow,endRow,sortColumn));
		
		ActionForward forward = new ActionForward(false,"/app/order/shoppingview2.jsp");
		return forward;
	}
