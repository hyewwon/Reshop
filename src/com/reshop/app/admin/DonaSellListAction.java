...
public class DonaSellListAction implements Action {
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int pageSize = 10;
		// 전체 게시글 개수
		int totalCnt = dsdao.getDonaSellCnt();
		...
		request.setAttribute("donaSellList", dsdao.getDonaSellList(startRow, endRow));
		ActionForward forward = new ActionForward(false, "/app/admin/donaSellList.jsp");
		return forward;
	}
}
