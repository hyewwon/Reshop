...
public class RefundListAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int pageSize = 10;
		//전체 게시글 개수
		int totalCnt = odao.getRefundCnt();
		...
		request.setAttribute("RefundList", odao.getRefundList(startRow,endRow));
		ActionForward forward = new ActionForward(false,"/app/admin/refundlist.jsp");
		return forward;
	}
}